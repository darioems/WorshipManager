//
//  IntegrantesNaipeTableViewController.m
//  WorshipManager
//
...
@implementation IntegrantesNaipeTableViewController


-(id)initWithIntegrantesIdNaipe:(int*)idNaipe {
	if (self = [super initWithNibName:@"IntegrantesNaipeTableViewController" bundle:nil]) {
		allIntegrantesIdNaipe = [IntegranteNaipe getAllIntegrantesWithIdNaipe:idNaipe];
		Naipes *naipe = [Naipes getNaipesWithidNaipe:idNaipe];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	IntegrantesTableViewController *view = [[IntegrantesNaipeTableViewController alloc] initWithNibName:@"IntegrantesTableViewController" bundle:nil];
